...
## Relation to [caveman](caveman_brussee.md)

The two are easy to confuse because both make things shorter.
They do not compress the same thing: caveman is about
...
See also [my thoughts on how I would adopt ponytail](../decisions/adopting_ponytail_without_its_always_on_ruleset.md).
